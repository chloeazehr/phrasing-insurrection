...
#loading data: 
#file.choose()
CorpusOne_sentenceLevel_PassPy <- read.csv("C:\\Users\\chloe\\OneDrive - UCB-O365\\Masters Thesis 2024\\GitHub Repo\\Corpus One\\PassivePy Analysis\\CorpusOne_PassivePy_SentenceLevel.csv")
...
CorpusOne_passivesyear <- as.numeric(str_extract(CorpusOne_sentenceLevel_PassPy$date, "\\d{4}"))
